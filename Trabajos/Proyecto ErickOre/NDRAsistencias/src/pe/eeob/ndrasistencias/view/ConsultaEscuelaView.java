...
import pe.eeob.ndrasistencias.controller.EscuelaController;
 ...
 * @author ErickOre
 */
public class ConsultaEscuelaView extends javax.swing.JInternalFrame {

    private EscuelaController control = new EscuelaController();
    private List<Escuela> lista;  
    /**
     * Creates new form ConsultaSede
     */
    public ConsultaEscuelaView() {
        initComponents();
    }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        try {
            ...
            //Proceso
            lista = control.getEscuelas(escuela);
            //Reporte
            mostrarLista(lista);
        } catch (Exception e) {
  ...
  private void mostrarLista(List<Escuela> lista) {
